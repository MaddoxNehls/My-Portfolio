...
import { FaAws, FaCss3Alt, FaDocker, FaHtml5, FaJava, FaLinux, FaNodeJs, FaPython, FaReact } from 'react-icons/fa';
import { GrMysql } from 'react-icons/gr';
import { IoLogoJavascript, IoLogoVue } from 'react-icons/io5';
import { SiCplusplus, SiMongodb, SiNextdotjs, SiPostgresql, SiReact, SiRedux, SiSpringboot, SiTailwindcss, SiTypescript } from 'react-icons/si';
...
const Section: React.FC<SectionProps> = ({ title, children }) => (
  <div className="mb-12">
    ...
    <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">{children}</div>
  </div>
);
...
const SkillCard: React.FC<SkillCardProps> = ({ item }) => (
  <Link
    href={item.link}
    className="relative mx-auto flex h-40 w-full max-w-full flex-col items-start border border-black/[0.2] p-3 transition-transform hover:scale-105 hover:shadow-lg active:scale-95 dark:border-white/[0.2]"
  >
